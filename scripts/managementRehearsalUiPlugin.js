  ...
  return {
    ...
    transform(code, id) {
      ...
      const instantArm = [
        ...
        "    // The media element clock is authoritative even while paused. React currentTime",
        "    // follows requestAnimationFrame and can be a few frames behind after a STOP.",
        ...
        "    // From a paused state, start from the exact media-element position captured above.",
